...
# "footer"
sed -i 's/<a target=&quot;_blank&quot; href=&quot;http:\/\/www.holding-graz.at\/abfallwirtschaft\/kundinnenservice\/altkleider.html&quot;>http:\/\/www.holding-graz.at\/abfallwirtschaft\/kundinnenservice\/altkleider.html<\/a><\/td><\/tr><\/table><\/td><\/tr><\/table>//g' $FILENAME


# description -> hg:desc
sed -i 's/description" v="<table><tr><td>/hg:description" v="/g' $FILENAME
...
echo BNAME ok
# LAGE -> hg:position
sed -i 's/<tr><td>LAGE<\/td><td>/    <tag k="hg:position" v="/g' $FILENAME
